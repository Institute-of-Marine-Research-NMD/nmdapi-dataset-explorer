 ...
 */
public class DatasetDAORestImpl implements DatasetDAO {
    
    private static final Logger LOG = LoggerFactory.getLogger(DatasetDAORestImpl.class);
    ...
    String datasetDataPath = "/nmdapi/nmd{dataType}/v1/{missionType}/{year}/{platform}/{delivery}";
     ...
     public Collection listExistingDatasets(String missionType, String year, String platform, String delivery) {
      LOG.debug("Start list datasets");
      String endPointURL = config.getString("base.URL") + deliveryPath;
